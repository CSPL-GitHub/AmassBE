...
urlpatterns = [
   ...
   path('order_data/', views.get_orders, name="order_data"),
   ...
   path('order_details/', views.get_order_info, name="order_details"),
   path('update_order_koms/', views.update_order_content, name="update_order_koms"),

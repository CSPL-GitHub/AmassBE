...
class POSUserAdmin(admin.ModelAdmin):
    fields = ('vendor', 'username', 'password', 'name', 'name_locale', 'phone_number', 'email', 'is_active',)
    
    list_display = ('name', 'name_locale', 'phone_number', 'is_active', 'vendor',)
    list_filter = ('is_active', 'vendor',)
    search_fields = ('name', 'name_locale', 'phone_number', 'email',)
